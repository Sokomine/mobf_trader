...
mobf_trader.add_trader( mobf_trader.npc_trader_prototype,
	...
	{ "default:pick_mese 1", {"default:mese_crystal 12","default:stone 5","default:water_source"}, "default:stone 60"}, -- TODO: this is just for testing
	{ {"default:shovel_steel 1", "default:desert_stone 55"}, "default:mese_crystal 2", "default:stone 10", "default:gold_ingot 9"}, -- TODO: for testing only
